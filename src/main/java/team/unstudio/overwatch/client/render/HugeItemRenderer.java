...
public class HugeItemRenderer implements IItemRenderer
{
    ...
    public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object[] data)
    {
        ...
        if (type == IItemRenderer.ItemRenderType.EQUIPPED_FIRST_PERSON)
        {
            ...
            GL11.glTranslatef(-0.15F, -0.2F, 0.25F);
        ...
        } else if (type == IItemRenderer.ItemRenderType.EQUIPPED)
        {
            ...
            GL11.glTranslatef(-0.425F, -0.1F, 0.03F);
    ...
    private void renderGiantItemEquipped(IIcon iicon, ItemStack par2ItemStack)
    {
        ...
        mc.renderEngine.bindTexture(mc.renderEngine.getResourceLocation(par2ItemStack.getItemSpriteNumber()));
