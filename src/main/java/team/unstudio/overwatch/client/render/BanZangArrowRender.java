 ...
 */
public class BanZangArrowRender extends Render{
        public static final ResourceLocation
                arrowtext = new ResourceLocation("overwatch:textures/entities/banzangarrow.png"); //贴图路径
    @Override
    public void doRender(Entity entity, double x, double y, double z,
        ...
        renderEngine.bindTexture(BanZangArrowRender.arrowtext); //绑定贴图
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return BanZangArrowRender.arrowtext;
    }
}
